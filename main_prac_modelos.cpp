...
/*------------- Alumno: Carlos Cuevas Salgado
	...
	Instrucciones : Para moverse atraves de la pnatalla se utilizaran las siguiente teclas :
		  ...
		  Con la tecla P el carro avanza
		  Con la tecla O el carro se detiene
		  Con la tecla I avanza hacia adelante
		  Con la tecla I + SHIFT avanza hacia atras el carro
...
void display(Shader shader, Model modelo, Model llantas)
{
	...
	model = glm::rotate(model, glm::radians(rotacion), glm::vec3(1, 0, 0));
