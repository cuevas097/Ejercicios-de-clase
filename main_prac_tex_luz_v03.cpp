...
/*------------- Alumno: Carlos Cuevas Salgado
	...
	Grupo de Teoria : 01
	Fecha de entrega 05 de Abril de 2019
...
//Texture
unsigned int	
				t_puerta, t_circuito, t_lamina, t_planta, t_agua, t_tela, //Texturas nuevas
                t_smile,
				t_toalla,
				t_unam,
				t_white,
...
void LoadTextures()
{
	...
	t_puerta = generateTextures("Texturas/TexturesCom_DoorMoorish0101_S.jpg", 0);
	t_circuito = generateTextures("Texturas/TexturesCom_Electronics0011_S.jpg", 0);
	t_lamina = generateTextures("Texturas/TexturesCom_MetalBulkheads0037_1_seamless_S.jpg",0);
	t_planta = generateTextures("Texturas/TexturesCom_Waterplants0031_1_seamless_S.jpg", 0);
	t_agua = generateTextures("Texturas/TexturesCom_WrinklesVarious0005_S.jpg", 0);
	t_tela = generateTextures("Texturas/TexturesCom_WrinklesVarious0005_S.jpg", 0);
	...
	glBindTexture(GL_TEXTURE_2D, t_circuito);
	glActiveTexture(GL_TEXTURE11);
	glBindTexture(GL_TEXTURE_2D, t_lamina);
	glActiveTexture(GL_TEXTURE12);
	glBindTexture(GL_TEXTURE_2D, t_planta);
	glActiveTexture(GL_TEXTURE13);
	glBindTexture(GL_TEXTURE_2D, t_agua);
	glActiveTexture(GL_TEXTURE14);
	glBindTexture(GL_TEXTURE_2D, t_tela);
}
...
void display(void)
{
	...
	lightingShader.setVec3("specularColor", 1.0f, 1.0f, 0.0f);
	...
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_circuito);
	glDrawArrays(GL_QUADS, 28, 4);

	//Derecha
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_lamina);
	lightingShader.setInt("material_specular", t_caja_brillo);
	glDrawArrays(GL_QUADS, 32, 4);
	
	//Izquierda
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_planta);
	lightingShader.setInt("material_specular", t_caja_brillo);
	...
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_tela);
