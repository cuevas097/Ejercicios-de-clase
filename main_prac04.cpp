...
Autor: Carlos Cuevas Salgado
	...
	Grupo de Teoria : 01
	Fecha de entrega 1 de Marzo de 2019
   ...
   Se hizo un dibujo de un humanoide usando como base un cupo para posteriormente escalar y transladar.
		   */
#include <glew.h>
#include <glfw3.h>
...
void display(void)
{
	...
	//Hombro
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.5f, 0.51f));
	...
	model = glm::scale(model, glm::vec3(.5, 3, 1));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
